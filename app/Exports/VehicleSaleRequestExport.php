...
class VehicleSaleRequestExport implements FromCollection, WithHeadings, WithTitle, WithEvents
{
    ...
    public function collection()
    {
        ...
        if ($this->month == 'alldata' && $this->year == 'alldata') {
            ...
            return DB::table('vehicle_sale_request as vsr')
                ->select('vehicle_type', 'vb.brand_name', 'vehicle_year', 'current_km', 'vehicle_color', 'name', 'email', 'phone_number', 'status', 'sending_email', 'description', 'vsr.created_at')
    ...
    public function registerEvents(): array
    {
        return [
            ...
            BeforeSheet::class => function (BeforeSheet $event) {
                ...
                $event->sheet->setCellValue('A1', 'Data Permintaan Jual Unit Customer');
            ...
            AfterSheet::class => function (AfterSheet $event) {
                $event->sheet->getStyle('A4:M4')->getFont()->setBold(true);
