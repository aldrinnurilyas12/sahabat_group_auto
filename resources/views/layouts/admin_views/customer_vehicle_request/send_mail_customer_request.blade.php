                ...
                @include('layouts.admin_views.header')
                    ...
                    <div class="card shadow mb-4">
                        <div  class="card-header py-3">
                            ...
                            <h5>Data permintaan pencarian unit kendaraan oleh : {{$vehicle_data->first()->name}}</h5>
                        </div>
                        <div class="card-body">
                            <div class="table-responsive">
                                <table style="font-size: 14px; color:black;" class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                                    ...
                                    <tbody>
                                        @foreach($vehicle_data as $customer_request)
                    ...
                    <form class="form_input" method="POST" action="{{route('response_customers_request', $vehicle_data->first()->id)}}" >
                        @csrf
                        @method('PUT')
                        <div class="form-group">
                            <input type="text" class="form-control" autocomplete="off" name="email" value="{{$vehicle_data->first()->email}}" hidden>
                        </div>
                        <div class="form-group">
                            <input hidden type="text" class="form-control" autocomplete="off" name="sending_mail" value="Ya">
                        </div>
                        <br>
                        <div class="form-group">
