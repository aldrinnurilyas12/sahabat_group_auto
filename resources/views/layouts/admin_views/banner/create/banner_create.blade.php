...
<head>
    ...
    <title>Tambah Data Banner - SAHABAT GROUP AUTO ADMINISTRATOR</title>
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div id="content">
                    ...
                    <h4 style="text-align:center;color:black;font-weight:bold;">Tambah Data Banner Website Utama</h4>
                    <br>
                    ...
                    <div style="display: flex; gap:50px;flex-wrap:wrap;" class="form-group-content">
                        <form class="form_input" method="POST" action="{{ route('master_banner.store') }}"
                            enctype="multipart/form-data">
                            @csrf

                            <div class="form-group">
                                <label>Nama Banner</label>
                                <input type="text" class="form-control" name="banner_name" autocomplete="off"
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="banner_title" autocomplete="off"
                                    placeholder="Masukan judul banner">
                            </div>

                            <div class="form-group">
                                <label>Konten Text</label>
                                <input type="text" class="form-control" name="text_content" autocomplete="off"
                                    placeholder="Masukan teks konten">
                            </div>

                            <div class="form-group">
                                <label>Button 1 (optional)</label>
                                <input type="text" class="form-control" name="button_1" autocomplete="off"
                                    placeholder="Masukan teks didalam button 1">
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="link_2" autocomplete="off"
                                    placeholder="Masukan link didalam button 2, contoh : https:api.whatsapp.com/62097471 ">
                            </div>

                            <div class="form-group">
                                <label>Upload gambar banner</label>
                                <input type="file" class="form-control" name="banner_file" autocomplete="off">
                            </div>
