...
<head>
    ...
    <title>Data Banner Landing Page - SAHABAT GROUP AUTO ADMINISTRATOR</title>
...
<body id="page-top">
            ...
            <div id="content">
                ...
                <div class="card shadow mb-4">
                    <div class="card-header py-3">
                        <h5 style="color: black;"><strong>Data Banner web utama PT Sahabat Group Auto</strong></h5>
                        <br>
                                        ...
                                        <tr style="width: 200px;">
                                            ...
                                            <td>
                                                <div style="display:flex; justify-content:center;gap:8px; "
                                                    class="action">
                                                    <a href="{{ route('banner_edit', $banner->id) }}"><i
                                                            class="fas fa-edit"></i></a>
                                                    <a style="size: 12px;" href="#" data-toggle="modal"
                                                        data-target="#deleteUnit{{ $banner->id }}"><i
    ...
    @foreach ($banner_data as $banner)
        <div class="modal fade" id="deleteUnit{{ $banner->id }}" tabindex="-1" role="dialog"
            aria-labelledby="exampleModalLabel{{ $banner->id }}" aria-hidden="true">
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="exampleModalLabel{{ $banner->id }}">Hapus data banner:
                    ...
                    <form method="POST" action="{{ route('master_banner.destroy', $banner->id) }}">
                        @csrf
                        @method('DELETE')
                        <div style="color: black;" class="modal-body">
                            Apakah Anda ingin menghapus data banner:
                            {{ $banner->banner_name }} ?
                            <br>
