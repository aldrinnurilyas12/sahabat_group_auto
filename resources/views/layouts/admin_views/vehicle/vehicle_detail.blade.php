...
<head>
    ...
    <title>
        {{ $vehicle->first()->brand . ' ' . $vehicle->first()->vehicle_type . ' ' . $vehicle->first()->manufacture_year }}
        - SAHABAT GROUP AUTO ADMINISTRATOR</title>
                ...
                <div class="container-fluid">
                    ...
                    <div class="card shadow mb-4">
                        <div style="display: flex;flex-wrap:wrap; justify-content:space-between;align-items:center;"
                            ...
                            <a href="{{ route('master_vehicle_data.index') }}" class="btn btn-info"><i
                                    class="fas fa-chevron-left"></i> &nbsp;Kembali</a>
                            <a href="#" data-toggle="modal" data-target="#infoModal"><i style="font-size: 20px;"
                            ...
                            @if ($vehicle->isNotEmpty())
                                ...
                                <div style="display: block; gap:10px; justify-content:center;margin-top:10p"
                                    ...
                                    <div class="active-status-vehicle">
                                        <p>Lokasi Unit: </p>
                                        <h5 class="btn-location">{{ $vehicle->first()->location_unit }}</h5>
                                    </div>
                                    <div class="active-status-vehicle">
                                        ...
                                        @if ($vehicle->first()->status_vehicle == 'Unit Terjual')
                                            ...
                                            @else
                                                <h5 class="btn-active-status-sold">
                                                    {{ $vehicle->first()->payment_method }}</h5>
                                            @endif
                                            <a style="font-size:12px; text-decoration:underline;"
                                                href="{{ route('payment_method', $vehicle->first()->id) }}">Atur
                                                Pembayaran <i class="fas fa-share-square"></i></a>
                                        @endif
                                    </div>
                        ...
                        <div class="card-body">
                            ...
                            <ul class="nav nav-tabs mb-3" id="ex1" role="tablist">
                                <li class="nav-item" role="presentation">
                                    <a data-mdb-tab-init class="nav-link active" id="ex1-tab-1" href="#ex1-tabs-1"
                                        role="tab" aria-controls="ex1-tabs-1" aria-selected="true">Detail
                                        Kendaraan</a>
                                </li>
                                <li class="nav-item" role="presentation">
                                    <a data-mdb-tab-init class="nav-link" id="ex1-tab-2" href="#ex1-tabs-2"
                                        role="tab" aria-controls="ex1-tabs-2" aria-selected="false">Simulasi
                                        Kredit</a>
                                </li>
                                <li class="nav-item" role="presentation">
                                    <a data-mdb-tab-init class="nav-link" id="ex1-tab-3" href="#ex1-tabs-3"
                                        role="tab" aria-controls="ex1-tabs-3" aria-selected="false">Dokumen
                                        Lainnya</a>
                                </li>
                                <li class="nav-item" role="presentation">
                                    <a data-mdb-tab-init class="nav-link" id="ex1-tab-4" href="#ex1-tabs-4"
                                        role="tab" aria-controls="ex1-tabs-4" aria-selected="false">Foto Unit</a>
                                </li>
                                <li class="nav-item" role="presentation">
                                    <a data-mdb-tab-init class="nav-link" id="ex1-tab-5" href="#ex1-tabs-5"
                                        role="tab" aria-controls="ex1-tabs-5" aria-selected="false">Media Player
                                        Unit</a>
                                </li>
                            </ul>
                            ...
                            <div class="tab-content" id="ex1-content">
                                ...
                                <div class="tab-pane fade" id="ex1-tabs-3" role="tabpanel"
                                    ...
                                    <h5 style="color: black;">Dokumen Kendaraan :
                                        {{ $vehicle->first()->brand . ' ' . $vehicle->first()->vehicle_type . ' ' . $vehicle->first()->manufacture_year }}
                                    </h5>
                                    <br>
                                ...
                                <div class="tab-pane fade" id="ex1-tabs-4" role="tabpanel"
                                    ...
                                    <h5 style="color: black;">Foto Unit :
                                        {{ $vehicle->first()->brand . ' ' . $vehicle->first()->vehicle_type . ' ' . $vehicle->first()->manufacture_year }}
                                    </h5>
                                    <br>
                                ...
                                <div class="tab-pane fade" id="ex1-tabs-5" role="tabpanel"
                                    ...
                                    <h5 style="color: black;">Media Player :
                                        {{ $vehicle->first()->brand . ' ' . $vehicle->first()->vehicle_type . ' ' . $vehicle->first()->manufacture_year }}
                                    </h5>
                                    <br>
                    ...
                    <div class="modal-dialog" role="document">
                        <div class="modal-content">
                            <div class="modal-header">
                                <h5 class="modal-title" id="exampleModalLabel">Ubah status unit :
                                    {{ $vehicle->first()->brand . ' ' . $vehicle->first()->vehicle_type . ' ' . $vehicle->first()->manufacture_year }}
                                </h5>
                                ...
                                <div style="color: black;" class="modal-body">
                                    ...
                                    @foreach ($status_category as $status)
                                        <div style="display: block;" class="listed-option">
                                            <input type="radio" name="status_vehicle_id"
                                                value="{{ $status->id }}" id="">
