    ...
    <div id="wrapper">
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="card shadow mb-4">
                        <div class="card-header py-3">
                            <div class="card-header py-3">
                                <h5 style="color: black;"><strong>Data Master Unit Kendaraan Admin PT Sahabat Group
                                        Auto</strong></h5>
                                <br>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <div style="display:flex; justify-content:center;gap:8px; "
                                                                class="action">
                                                                <a href="{{ route('edit_vehicle', $cars->id) }}"><i
                ...
                @foreach ($vehicle as $cars)
                    <div class="modal fade" id="deleteUnit{{ $cars->id }}" tabindex="-1" role="dialog"
                        aria-labelledby="exampleModalLabel{{ $cars->id }}" aria-hidden="true">
                        <div class="modal-dialog" role="document">
                            <div class="modal-content">
                                <div class="modal-header">
                                    <h5 class="modal-title" id="exampleModalLabel{{ $cars->id }}">Hapus data
                                        unit:
