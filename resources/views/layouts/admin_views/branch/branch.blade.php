...
<body id="page-top">
                                        ...
                                        <tr style="width: 200px;">
                                            ...
                                            <td>
                                                <div style="display:flex; justify-content:center;gap:8px; "
                                                    class="action">
                                                    <a href="{{ route('update_branch.update', $cab->id) }}"><i
                                                            class="fas fa-edit"></i></a>
                                                    <a style="size: 12px;" href="#" data-toggle="modal"
                                                        data-target="#deleteUnit{{ $cab->id }}"><i
                                            ...
                                            <td>
                                                ...
                                                <table style="font-size: 14px; color:black;"
                                                    ...
                                                    <tr>
                                                        ...
                                                        <th>Unit Ready</th>
                                                        <th>Unit Sold</th>
                                                        <th>Unit Pengajuan Kredit</th>
                                                        <th>Unit Dalam Perbaikan</th>
    ...
    @foreach ($branch as $cab)
        <div class="modal fade" id="deleteUnit{{ $cab->id }}" tabindex="-1" role="dialog"
            aria-labelledby="exampleModalLabel{{ $cab->id }}" aria-hidden="true">
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="exampleModalLabel{{ $cab->id }}">Hapus data cabang:
                            {{ $cab->location_code . ' - ' . $cab->location_name }}</h5>
