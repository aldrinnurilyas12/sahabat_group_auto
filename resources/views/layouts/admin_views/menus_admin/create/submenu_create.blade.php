                    ...
                    @foreach ($main_menu as $main)
                        <form class="form_input" method="POST" action="{{ route('submenu_save') }}">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" value="{{ $main->menu_name }}"
                                    placeholder="Masukan nama menu" disabled autocomplete="off">
                            </div>
                            <div class="form-group">
                                <label>Nama Submenu</label>
                                <input type="text" class="form-control" name="submenu_name"
                                    placeholder="Masukan nama submenu" autocomplete="off">
                            </div>
                            <div class="form-group">
                                <label>Icon Menu</label>
                                <input type="text" class="form-control" name="submenu_icons"
                                    placeholder="Masukan Icon menu, cth: fas fa-users" autocomplete="off">
                            </div>
                            <div class="form-group">
                                <label>Link</label>
                                <input type="text" class="form-control" name="submenu_link"
                                    placeholder="Masukan link submenu" autocomplete="off">
                            </div>
                            <div class="form-group">
                            ...
                            <input hidden type="text" class="form-control" name="parent_id"
                                value="{{ $main->id }}">
