...
<title>Tambah Menu Utama - SAHABAT GROUP AUTO ADMINISTRATOR</title>
    ...
    <div id="wrapper">
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <h4 style="text-align:center;color:black;font-weight:bold;">Tambah Menu Utama</h4>
                <div class="form-group-content">
                    <form class="form_input" method="POST" action="{{ route('master_main_menus.store') }}">
                        @csrf
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" name="menu_icon"
                                placeholder="Masukan Icon menu, cth: fas fa-users">
