                    ...
                    @foreach ($submenu as $sub)
                        <div class="form-group-content">
                            <form class="form_input" method="POST"
                                action="{{ route('edit_submenu.update', ['id' => $sub->id]) }}">
                                ...
                                <div class="form-group">
                                    <input type="text" name="id" class="form-control" disabled
                                        autocomplete="off" value="{{ $sub->id }}" hidden>
                                </div>

                                <div class="form-group">
                                    <label>Nama Submenu</label>
                                    <input name="submenu_name" type="text" class="form-control" autocomplete="off"
                                        value="{{ $sub->submenu_name }}">
                                </div>

                                <div class="form-group">
                                    <label>Icon</label>
                                    <input name="submenu_icons" type="text" class="form-control" autocomplete="off"
                                        value="{{ $sub->submenu_icons }}">
                                </div>

                                <div class="form-group">
                                    <label>Link</label>
                                    <input name="submenu_link" type="text" class="form-control" autocomplete="off"
                                        value="{{ $sub->submenu_link }}">
                                </div>

                                <div class="form-group">

                                    <input name="parent_id" type="text" class="form-control" autocomplete="off"
                                        value="{{ $sub->parent_id }}" hidden>
                                </div>
                    @endforeach
