    ...
    <div id="wrapper">
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div class="container-fluid">
                                        ...
                                        <tr style="width: 200px;">
                                            ...
                                            <td>
                                                <div style="display:flex; justify-content:center;gap:8px; "
                                                    class="action">
                                                    <a href="{{ route('master_main_menus.update', $main->id) }}"><i
                                                            class="fas fa-edit"></i></a>
                                                    <a style="size: 12px;" href="#" data-toggle="modal"
                                                        data-target="#deleteMenu{{ $main->id }}"><i
                                                            class="fas fa-trash"></i></a>
                                                </div>
                                            </td>
                                            <td>{{ $main->menu_name }}</td>
                                            <td style="text-align: center"><a
                                                    href="{{ route('submenu_detail', $main->id) }}"><i
                ...
                @foreach ($main_menu as $main)
                    <div class="modal fade" id="deleteMenu{{ $main->id }}" tabindex="-1" role="dialog"
                        aria-labelledby="exampleModalLabel{{ $main->id }}" aria-hidden="true">
                        <div class="modal-dialog" role="document">
                            <div class="modal-content">
                                <div class="modal-header">
                                    <h5 class="modal-title" id="exampleModalLabel{{ $main->id }}">Hapus Data Menu
                                        Utama: {{ $main->menu_name }}</h5>
