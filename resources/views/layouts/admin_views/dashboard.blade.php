...
<head>
    ...
    <title>Dashboard - SAHABAT GROUP AUTO ADMINISTRATOR</title>
                                    ...
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            <div class="text-xs font-weight-bold text-primary text-uppercase mb-1">
                                                Karyawan</div>
                                            <div class="h5 mb-0 font-weight-bold text-gray-800">{{ $employee_total }}
                                            </div>
                                            <a href="{{ route('master_employee.index') }}"><i class="fa fa-arrow-right"
                                ...
                                <div class="card-body">
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            <div class="text-xs font-weight-bold text-primary text-uppercase mb-1">
                                                unit kendaraan</div>
                                            <div class="h5 mb-0 font-weight-bold text-gray-800">{{ $vehicle_total }}
                                            </div>
                                            <a href="{{ route('master_vehicle_data.index') }}"><i
                                    ...
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            <div class="text-xs font-weight-bold text-success text-uppercase mb-1">
                                                iklan mobil</div>
                                            <div class="h5 mb-0 font-weight-bold text-gray-800">{{ $vehicle_ads }}
                                            </div>
                        ...
                        <div class="col-xl-2 col-md-6 mb-4">
                            <div class="card border-left-info shadow h-100 py-2">
                                <div class="card-body">
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            <div class="text-xs font-weight-bold text-info text-uppercase mb-1">Web
                                                Visitor
                                            </div>
                                            <div class="row no-gutters align-items-center">
                                                <div class="col-auto">
                                                    <div class="h5 mb-0 mr-3 font-weight-bold text-gray-800">
                                                        {{ $visitorweb_landingpage }} </div>
                                    ...
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            ...
                                            <div style="font-size: 20px;"
                                                class="h5 mb-0 font-weight-bold text-gray-800">{{ $users_online }}
                                            </div>
                                            <a href="{{ route('users_activity') }}"><i class="fa fa-arrow-right"
                                                    aria-hidden="true"></i></a>
                                            </a>
                                        </div>
                                        <div class="col-auto">
                        ...
                        <div class="col-xl-8 col-lg-7">
                            <div class="card shadow mb-4">
                                ...
                                <div
                                    ...
                                    <h6 class="m-0 font-weight-bold text-primary">Agenda
