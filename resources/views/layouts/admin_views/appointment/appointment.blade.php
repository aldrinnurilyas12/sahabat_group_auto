...
<body id="page-top">
            ...
            <div id="content">
                ...
                <div class="card shadow mb-4">
                    <div class="card-header py-3">
                        <h5 style="color: black;"><strong>Data Appointment (Kunjungan & Test Drive) Customer</strong>
                        </h5>
                        ...
                        <div style="color: black;" class="form-group">
                            <form action="{{ route('filter_appointment') }}" method="GET">
                                ...
                                <div style="display: flex;gap:10px;" class="grouped-container">
                                    ...
                                    <a href="{{ route('customers_appointment.index') }}"
                                            ...
                                            <td style="font-size:16px;">
                                                <div style="display:flex; justify-content:center;gap:8px; "
                                                    ...
                                                    @if ($appointment->appointment_status == null)
                                                        <a style="font-size: 14px;" class="btn btn-primary"
    ...
    @foreach ($appointment_data as $appointment)
        <div class="modal fade" id="changeStatus{{ $appointment->id }}" tabindex="-1" role="dialog"
            aria-labelledby="exampleModalLabel{{ $appointment->id }}" aria-hidden="true">
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="exampleModalLabel{{ $appointment->id }}">Ubah kehadiran Customer
                            Appointment {{ $appointment->location_unit . ' - ' . $appointment->unit }}</h5>
                    ...
                    <form method="POST" action="{{ route('change_appointment_status', $appointment->id) }}">
                        ...
                        <div style="color: black;" class="modal-body">
                            ...
                            <strong>{{ $appointment->name }}</strong> dan unit
                            ...
                            <div style="display: block;" class="form-group">
                                ...
                                <br>
                                <input type="radio" value="tidak datang" name="appointment_status" id="">
                                Tidak Datang
                            </div>
                        </div>
