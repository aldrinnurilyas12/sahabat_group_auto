                                ...
                                <table style="font-size: 14px; color:black;" class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                                    ...
                                    <tbody>
                                        ...
                                        <tr style="width: 200px;">
                                            <td><?php echo $no++ ?></td>
                                            <td><div style="display:flex;gap:10px; justify-content:center;gap:8px;width:180px; " class="action">
                                                @if($ticket->approval_by_it == 'sudah konfirmasi' && $ticket->status == 'on progress')
                                                <a class="btn btn-primary" href="{{route('eticket_detail', $ticket->id)}}">Lihat</a>
                                                <a class="btn btn-secondary" href="{{route('edit_eticket', $ticket->id)}}">Ubah</a>
                                                ...
                                                {{-- <a style="size: 12px;" href="#" data-toggle="modal" data-target="#deleteUnit{{$ticket->id}}"><i class="fas fa-trash"></i></a> --}}
                                            </td>
                                            <td>{{$ticket->name}}</td>
                                            <td>{{$ticket->title}}</td>
