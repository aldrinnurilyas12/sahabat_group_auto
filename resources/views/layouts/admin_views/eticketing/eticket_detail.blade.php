                ...
                <div id="content">
                    ...
                    <div class="form-group-content">
                        ...
                        <form class="form_input"> 
                            ...
                            <hr>
                            <input hidden type="text" class="form-control" value="{{$ticket->id}}" name="id" autocomplete="off" readonly>

                            <div class="form-group">
                                <label >Nomor E-Tiket</label>
                                <input type="text" class="form-control" value="{{$ticket->id}}" autocomplete="off" readonly>
                            </div>

                            <div class="form-group">
                                <label >Judul</label>
                                <input type="text" class="form-control" value="{{$ticket->title}}" autocomplete="off" readonly>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <img width="90" height="90" src="{{asset('storage/' . $ticket->attachment_files)}}" alt="">
                                <a class="btn btn-primary" href="#"  href="#" data-toggle="modal" data-target="#showFile{{$ticket->id}}">Lihat foto</a>
                                @else
                                -
                                @endif
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" value="{{date('d F Y', strtotime($ticket->created_at))}}" autocomplete="off" readonly>
                            </div>
                                    ...
                                    <tbody>
                                       <tr>
                                        <td>
                                            ...
                                            {{$ticket->status}}
                                            @endif</td>
                                        <td> @if($ticket->scheduled)
                                            {{date('d F Y', strtotime($ticket->scheduled))}}
                                            @else
                                            <p>-</p>
                                            @endif</td>
                                        <td> @if($ticket->approval_by_it)
                                            <p class="text-success">{{$ticket->approval_by_it}}</p>
                                            @else
                                            <p>-</p>
                                            @endif</td>
                                        <td> @if($ticket->task_complete_date)
