                    ...
                    <div style="display: flex; gap:30px;flex-wrap:wrap;width:100%;" class="form-group-content">
                        <div style="display: block;" class="container-infromation">
                            ...
                            <div style="width: 300px; height:max-content; padding:8px;" class="card shadow mb-4">
                                ...
                                <div style="color: black;" class="card-body">
                                    <ul>
                                        <li>Pembuatan E-Ticket diajukan untuk mengajukan perbaikan pada
                                            Software/Hardware PT Sahabat Group Auto</li>
                                        <br>
                                        <li>Pembuatan E-Ticket hanya bisa dilakukan 1 kali sehari dan dibuka pada jam 13
                                        </li>
                                    </ul>
                        ...
                        <div class="card-shadow">
                            <div class="card shadow mb-4 new">
                                ...
                                <form class="form_input" method="POST" action="{{ route('master_eticket.store') }}"
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select class="form-control" name="eticket_category" id="">
                                            ...
                                            @foreach ($eticket_category as $category)
                                                <option
                                                    value="{{ $category->menu_name . ' - ' . $category->submenu_name }}">
                                                    {{ $category->menu_name . ' - ' . $category->submenu_name }}
                                                </option>
                                            @endforeach
                                            <option value="Error Wi-Fi">Wi-Fi Bermasalah</option>
                                            <option value="Error Printer">Printer Bermasalah</option>
                                            <option value="Server Services">Layanan Server</option>
                                            <option value="Error Laptop">Laptop Bermasalah</option>
                                        </select>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" name="title" autocomplete="off"
                                            placeholder="Masukan Judul E-Tiket">
                                        @if ($errors->has('title'))
                                    ...
                                    <div class="form-group">
                                        ...
                                        <textarea class="form-control" name="main_issue" id="" cols="30" rows="5"
                                            placeholder="Masukan permasalahan yang dihadapi"></textarea>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="file" class="form-control" name="attachment_files"
                                            autocomplete="off">
                                    </div>
