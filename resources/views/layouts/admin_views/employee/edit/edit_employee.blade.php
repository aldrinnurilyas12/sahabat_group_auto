                    ...
                    @foreach ($employee as $emp)
                        <form class="form_input" method="POST" action="{{ route('edit_employee.update', $emp->id) }}">
                            ...
                            <div class="form-group">
                                ...
                                <small>
                                    <p style="color: gray; font-style:italic;font-size:12px;">*pilih kantor cabang jika
                                        ingin merubah</p>
                                </small>
                                <select class="form-control" name="branch_id" id="branchSelected">
                                    @foreach ($branch as $cabang)
                                        <option value="{{ $cabang->id }}"
                                            {{ $cabang->location_name == $emp->location_name ? 'selected' : '' }}>
                            ...
                            <div class="form-group">
                                ...
                                <small>
                                    <p style="color: gray; font-style:italic;font-size:12px;">*pilih posisi jika ingin
                                        merubah</p>
                                </small>
                                <select class="form-control" name="job_position" id="jobSelected">
                                    @foreach ($job_position as $job)
                                        <option value="{{ $job->id }}"
                                            {{ $job->position_name == $emp->job_position ? 'selected' : '' }}>
                                ...
                                <select class="form-control" name="bank_id" id="">
                                    ...
                                    @foreach ($banks as $bank)
                                        <option value="{{ $bank->id }}"
                                            {{ $bank->bank == $emp->bank ? 'selected' : '' }}>{{ $bank->bank }}
                                        </option>
                                    @endforeach
                                </select>
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" value="{{ $emp->bank_account }}"
