...
<head>
    ...
    <title>Buat Blog - SAHABAT GROUP AUTO ADMINISTRATOR</title>
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div id="content">
                    ...
                    <h4 style="text-align:center;color:black;font-weight:bold;">Tambah Data Blog</h4>
                    
                    <div style="display: flex; gap:50px;flex-wrap:wrap;" class="form-group-content">
                        <form class="form_input" method="POST" action="{{ route('master_blog.store')}}" enctype="multipart/form-data">
                            @csrf   
                            
                            <div class="form-group">
                                <label>Judul Blog</label>
                                <input type="text" class="form-control" name="title" autocomplete="off" placeholder="Masukan Judul Blog">
                            </div>

                            <div class="form-group">
                                <label>Isi Blog</label>
                               <textarea class="form-control" name="subtitle" id="" cols="4" rows="4"></textarea>
                            </div>

                            <div class="form-group">
                                <label>Foto</label>
                                <input type="file" class="form-control" name="blog_foto[]" multiple autocomplete="off">
