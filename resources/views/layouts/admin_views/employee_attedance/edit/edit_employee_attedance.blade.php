                ...
                <div class="form-group-content">
                    ...
                    @foreach ($employee_attedance as $emp)
                        <form class="form_input" method="POST"
                            action="{{ route('edit_employee_attedance.update', $emp->id) }}"
                            ...
                            <div class="form-group">
                                <input hidden type="text" class="form-control" name="employee_id"
                                    value="{{ $emp->employee_id }}" readonly autocomplete="off">
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="nik"
                                        value="{{ $emp->name }}" readonly autocomplete="off">
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    <label>Upload Surat Sakit dari Dokter | Format : PNG & JPG <span
                                            style="font-size: 14px; color:rgb(17, 25, 255); font-style:italic;"> (Jika
                                            Karyawan
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" value="{{ $emp->attedance_date }}"
                                        name="attedance_date" readonly autocomplete="off">
