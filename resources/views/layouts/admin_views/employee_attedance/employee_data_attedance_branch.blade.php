                ...
                <div class="container-fluid">
                    <div class="card shadow mb-4">
                        <div class="card-header py-3">
                            <h5 style="color: black;margin-bottom:1rem;"><strong>Presensi Karyawan [
                            ...
                            <div class="row">
                                <div class="col-xl-2 col-md-6 mb-4">
                                    <div style="background-image: linear-gradient(to right, #8E2DE2, #4A00E0);color:white;"
                                            ...
                                            <div class="row no-gutters align-items-center">
                                                <div class="col mr-2">
                                                    <div style="color: white;"
                                                        ...
                                                        Total Presensi</div>
                                                    <div style="color: white;" class="h5 mb-0 font-weight-bold">
                                                        {{ $attedance_total }}</div>
                                                </div>
                                                <div class="col-auto">
                    ...
                    <div class="card shadow mb-4">
                        <div class="card-header py-3">
                            <div style="color: black;display:flex;gap:3em;flex-wrap:wrap;margin-bottom :5em;"
                                class="form-group">

                                <div style="display: block;" class="title">


                                    <h5 style="color: black;"><strong>Presensi Karyawan
                                            {{ app('App\Http\Controllers\Api\LoginAdminController')->getUsers()->location_name }}</strong>
                                    </h5>
                                    <p>Tanggal : @php echo date('F Y') @endphp</p>



                                    <div style="display: block; gap:10px; font-family:inter,sans-serif;justify-content:space-between;align-items:center;"
                                        class="btn-content">
                                            ...
                                            <form action="{{ route('filter_attedance') }}" method="GET">
                                                ...
                                                <div style="display: flex;gap:10px;" class="grouped-container">
                                                    ...
                                                    <button style="height: 40px; align-self:end;" type="submit"
                                                        class="btn btn-secondary">Pilih</button>
                                                </div>
                                                &nbsp;
                            ...
                            <section class="employee_statistic_attendance">
                                <h5 style="color: black;margin-bottom:1rem;"><strong>Data Presensi Karyawan
                                        {{ app('App\Http\Controllers\Api\LoginAdminController')->getUsers()->location_name }}
                                </h5>

                                <div style="display: flex; gap:10px; align-items:center;" class="dfex-excel">
                                ...
                                <div style="display: block;" class="employee_statistic_attendance">
                                    <div class="row">
                                        <div class="col-xl-2 col-md-6 mb-4">
                                            <div style="background-image: linear-gradient(to right, #8E2DE2, #4A00E0);color:white;"
                                                class="card shadow h-100 py-2">
                                                ...
                                                <div class="card-body">
                                                    <div class="row no-gutters align-items-center">
                                                        <div class="col mr-2">
                                                            ...
                                                            <div style="color: white;"
                                                                class="h5 mb-0 font-weight-bold">
                                                                {{ $attendance_abnormal_branch }}</div>
                                                        </div>
                                                        <div class="col-auto">
                                                            <i class="fa fa-users fa-2x text-gray-300"></i>
                                                        </div>
                                            ...
                                            <table style="font-size: 14px; color:black;" class="table table-bordered"
                                                ...
                                                <thead>
                                                    ...
                                                    <tr>
                                                        ...
                                                        @foreach ($date_listed as $list)
                                                            <th style="overflow-x: scroll;">{{ $list->date_list }}
                                                            </th>
                                                        @endforeach
                                                    </tr>
                                                </thead>
                                                ...
                                                <tbody>
                                                    @if ($employee_attedance->isNotEmpty())
                                                                ...
                                                                @foreach ($date_listed as $list)
                                                                    <td>
                                                                                ...
                                                                                function ($attendance) use (
                                                                                    ...
                                                                                    return $attendance->employee_id ==
                                                                                        ...
                                                                                        date(
                                                                                            'd',
                                                                                            strtotime(
                                                                                                $attendance->attedance_date,
                                                                                            ),
                                                                                        ) == $list_day; // Compare days
                                                                                },
                                                                            );
                                                                        ...
                                                                        @if ($attendanceRecord && $attendanceRecord->attedance_type == 'hadir')
                                                                            <span
                                                                                style="background:rgba(193, 255, 185, 0.445); color:rgb(0, 255, 60); border-radius:5px;">
                                                                                Hadir
                                                                            </span>
                                                                        @elseif($attendanceRecord && $attendanceRecord->attedance_type == 'izin')
                                                                            <span
                                                                                style="background:rgba(246, 255, 0, 0.445); color:rgb(0, 0, 0); border-radius:5px;">
                                                                                Izin
                                                                            </span>
                                                                        @elseif($attendanceRecord && $attendanceRecord->attedance_type == 'sakit')
                                                                            <span
                                                                                style="background:rgba(0, 26, 255, 0.445); color:rgb(25, 0, 255); border-radius:5px;">
                                                                                Sakit
                                                                            </span>
                                                                        @else
                                                                        @endif
                                                        ...
                                                        @endforeach
                                                    @else
                                                        <h4 style="text-align: center" class="text-danger">Tidak ada
                                                            data
                                                        </h4>
                                                    @endif
                                                </tbody>
