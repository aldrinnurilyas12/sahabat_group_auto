                                ...
                                <div style="display: block;" class="d-block">
                                    <form action="{{ route('filter_attedance') }}" method="GET">
                                        ...
                                        <div style="display: flex;gap:10px;" class="grouped-container">
                                            ...
                                            <a href="{{ route('master_employee_attedance.index') }}"
                                    ...
                                    <div style="font-size:14px;" class="result-selected">
                                        @if ($employee_attedance->isNotEmpty())
                                            ...
                                            <div class="alert alert-warning">
                                                Bulan :
                                                {{ \Carbon\Carbon::parse(optional($employee_attedance->first())->attedance_date)->format('F') ?? 'Bulan tidak tersedia' }}
                                                <br>

                                                <!-- Menampilkan tahun yang dipilih dari array $year -->
                                                Tahun :
                                                {{ \Carbon\Carbon::parse(optional($employee_attedance->first())->attedance_date)->format('Y') ?? 'Tahun tidak ada' }}
                                            </div>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <div style="display:flex; justify-content:center;gap:8px; "
                                                            class="action">
                                                            <a
                                                                href="{{ route('edit_attedance_layout', ['nik' => auth()->user()->nik, 'id' => $emp->id]) }}"><i
                                                    ...
                                                    <td>
                                                        ...
                                                        @elseif($emp->created_at && \Carbon\Carbon::parse($emp->created_at)->hour >= 8 && $emp->attedance_type == 'hadir')
                                                            ...
                                                            @if (isset($delay))
                                                                <p
                                                                    style="font-style: italic; color:red;font-size:12px;">
                                                                    Anda telat {{ $delayHours }} jam
