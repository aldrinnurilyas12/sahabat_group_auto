                    ...
                    <form class="form_input" method="POST" action="{{ route('master_employee_attedance.store') }}"
                        ...
                        <div class="form-group">
                            ...
                            <input hidden type="text" class="form-control" name="employee_id"
                                value="<?php echo app('App\Http\Controllers\Api\LoginAdminController')->getUsers()->employee_id; ?>">
                        ...
                        <div class="form-group">
                            <label>Kantor</label>
                            <input type="text" class="form-control" value="<?php echo app('App\Http\Controllers\Api\LoginAdminController')->getUsers()->location_name; ?>"
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" name="reasons"
                                placeholder="Masukan alasan jika izin" autocomplete="off">
                        </div>

                        <div class="form-group">
                            <label>Upload Surat Sakit dari Dokter | Format : PNG & JPG <span
                                    style="font-size: 14px; color:rgb(17, 25, 255); font-style:italic;"> (Jika Karyawan
                                    Mengalami Sakit)</span></label>
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" value="{{ date('Y-m-d') }}" class="form-control" name="attedance_date"
