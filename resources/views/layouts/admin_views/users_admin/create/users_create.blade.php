                    ...
                    <div style="display: flex; gap:50px;flex-wrap:wrap;" class="form-group-content">
                        <form class="form_input" method="POST" action="{{ route('save_users') }}">
                            ...
                            <div class="form-group">
                                ...
                                <span style="font-size: 12px;color:gray;font-style:italic;margin-bottom:4px;">*NIK akan
                                    muncul otomatis ketika pilih Karyawan</span>
                                <input id="showNik" type="text" class="form-control" name="nik"
                                    autocomplete="off" aria-valuemax="{{ old('nik') }}" readonly>
                            </div>
                            <div class="form-group">
                                <label style="margin-bottom: 0;">Email</label>
                                <span style="font-size: 12px;color:gray;font-style:italic;margin-bottom:4px;">*Email
                                    akan muncul otomatis ketika pilih Karyawan</span>

                                <input id="showEmail" type="email" class="form-control" name="email"
                                    autocomplete="off" value="{{ old('email') }}" readonly>
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                <input id="showBirth" type="password" value="{{ old('birth_date') }}"
                                    class="form-control" name="password" autocomplete="off" readonly hidden>
                            </div>


                            {{-- <div class="form-group">
                                <label>Konfirmasi Password</label>
                                <input id="showBirth" type="password" class="form-control" autocomplete="off"
                        ...
                        <div style="width: 400px; height:max-content; padding:8px;" class="card shadow mb-4">
                            ...
                            <div class="card-body">
                                <ul>
                                    <li>Pembuatan akun admin ditujukan untuk seseorang/karyawan dalam mengelola kontent
                                        website Sahabat Group</li>
                                    <br>
                                    ...
                                    <br>
                                    <li>Untuk mengaktifkan akun pengguna untuk akses masuk ke web administrasi PT
                                        Sahabat Group Auto, Harap Konfirmasi Email Karyawan yang sudah terdaftar</li>
                                </ul>
    ...
    <script>
        document.getElementById('employeeId').addEventListener('change', function() {
            ...
            if (!employeeId) {
                ...
                document.getElementById('showBirth').value = '';
                return;
            ...
            fetch('/get_email_nik/' + employeeId).then(response => {
                ...
                if (data.birth_date) {
                    ...
                    const month = String(birthDate.getMonth() + 1).padStart(2, '0'); // bulan dimulai dari 0
                    const year = birthDate.getFullYear();

                    const formattedDate = `${day}${month}${year}`;
                    document.getElementById('showBirth').value = formattedDate;
                }
            })
        })
    </script>
