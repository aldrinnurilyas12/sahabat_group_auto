                ...
                <div class="card shadow mb-4">
                    <div class="card-header py-3">
                        ...
                        <div style="display: flex; flex-wrap:wrap; gap:10px;" class="component">
                            @if ($finance_session)
                                <a href="{{ route('create_payroll', $payroll_data->first()->id) }}"
                                ...
                                <tbody>
                                    ...
                                    @foreach ($payroll_data as $payroll)
                                        <tr style="width: 200px;">
                                                    ...
                                                    @if (app('App\Http\Controllers\Api\LoginAdminController')->getUsers()->position_name == 'Head of Finance Operation')
                                                        @if ($payroll->approval_by_head_of_finance == 'confirmed')
                                                            <a class="btn btn-secondary" style="size: 12px;"
                                                                href="{{ route('get_payroll_detail', $payroll->payroll_code) }}">Approved</a>
                                                        @else
                                                            <a class="btn btn-primary" style="size: 12px;"
                                                                href="{{ route('get_payroll_detail', $payroll->payroll_code) }}">Approve</a>
                                                        @endif
                                                    ...
                                                    @elseif(app('App\Http\Controllers\Api\LoginAdminController')->getUsers()->position_name == 'Head of Branch Operations')
                                                        ...
                                                        @else
                                                            <a class="btn btn-primary" style="size: 12px;"
                                                                href="{{ route('get_payroll_detail', $payroll->payroll_code) }}">Approve</a>
                                                        @endif
                                                    @elseif (app('App\Http\Controllers\Api\LoginAdminController')->getUsers()->position_name == 'Finance Staff')
                                                        @if ($payroll->payroll_file)
                                                            <a class="btn btn-secondary" style="size: 12px;"
                                                                href="{{ route('get_payroll_detail', $payroll->payroll_code) }}">Approved</a>
                                                        @else
                                                            <a class="btn btn-primary" style="size: 12px;"
                                                                href="{{ route('get_payroll_detail', $payroll->payroll_code) }}">Bayar</a>
                                                        @endif
                                                    @else
                                            ...
                                            @if ($payroll->status)
                                                @if ($payroll->pay_status == 'pay_done')
