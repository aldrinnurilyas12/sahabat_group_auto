                ...
                <div class="card shadow mb-4">
                    ...
                    <ul class="nav nav-tabs mb-3" id="ex1" role="tablist">
                        <li style="padding: 15px;background:whitesmoke;" class="nav-item" role="presentation">
                            <a data-mdb-tab-init class="nav-link-spk active" id="ex1-tab-1" href="#ex1-tabs-1"
                                role="tab" aria-controls="ex1-tabs-1" aria-selected="true">Data
                                Semua SPK</a>
                        </li>
                                ...
                                <div class="table-responsive">
                                    <table style="font-size: 14px; color:black;" class="table table-bordered"
                                        ...
                                        <tbody>
                                            <?php $no = 1;
                                            ?>
                                            @foreach ($all_spk_data as $spk_all)
                                                <tr style="width: 200px;">
                                                    <td><?php echo $no++; ?></td>
                                                    <td>
                                                        <div style="display:flex; justify-content:center;gap:8px; "
                                                    ...
                                                    <td>{{ 'Rp ' . number_format($spk_all->price) }}</td>
                                                    <td>{{ $spk_all->price_nominal }}</td>
                                                    <td>{{ $spk_all->down_payment }}</td>
                                                    <td>{{ $spk_all->name }}</td>
                                                    ...
                                                    <td>{{ $spk_all->created_at }}</td>
                                                    <td>{{ $spk_all->created_by }}</td>
                                                    <td>{{ $spk_all->updated_at }}</td>
                                                    <td>{{ $spk_all->updated_by }}</td>
                                                </tr>
                                            @endforeach
...
<script>
    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        const tabLinks = document.querySelectorAll('.nav-link-spk');
