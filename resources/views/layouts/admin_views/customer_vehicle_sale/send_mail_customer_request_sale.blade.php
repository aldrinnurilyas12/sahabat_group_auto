            ...
            <div id="content">
                ...
                <div class="form-group-content">
                    <form class="form_input" method="POST"
                        action="{{ route('response_customers_request_sale', $customer_request_sale_data->first()->id) }}">
                        @csrf
                        @method('PUT')
                        <div class="form-group">
                            <input type="text" class="form-control" autocomplete="off" name="email"
                                value="{{ $customer_request_sale_data->first()->email }}" hidden>
                        </div>
                        <div class="form-group">
                            <input hidden type="text" class="form-control" autocomplete="off" name="sending_email"
                                value="Ya">
                        </div>
                        ...
                        <button type="submit" class="btn btn-dark">Kirim Email <i class="fa fa-paper-plane"
