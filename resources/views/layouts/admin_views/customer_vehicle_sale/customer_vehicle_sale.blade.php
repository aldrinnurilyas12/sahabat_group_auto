...
<head>
    ...
    <title>Data Permintaan Jual Unit Kendaraan - SAHABAT GROUP AUTO ADMINISTRATOR</title>
                        ...
                        <div  class="card-header py-3">
                            ...
                            <div style="color: black;" class="form-group">
                                ...
                                <div style="font-size:14px;" class="result-selected">
                                        ...
                                        @elseif($customer_request_sale_data->isEmpty())
                                        <div class="alert alert-warning">
                                            Tidak ada data.
                                        </div>
                                        @endif  
                                ...
                                <table style="font-size: 14px; color:black;" class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                                    ...
                                    <tbody>
                                        ...
                                        <tr style="width: 200px;">
                                            ...
                                            <td><textarea readonly name="" id="" style="height: 90px;">
