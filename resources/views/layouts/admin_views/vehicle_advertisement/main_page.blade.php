            ...
            <div id="content">
                ...
                <div class="card shadow mb-4">
                    <div class="card-header py-3">
                        ...
                        <br>
                        <form style="display: flex;gap:9px;" action="{{ route('advertisement_export') }}"
                            method="POST">
                            @csrf
                            ...
                            <div class="btn-change">
                                <a class="btn btn-primary" href="#" data-toggle="modal"
                                    data-target="#changeAds">Atur Urutan Iklan</a>
                            </div>
                        </form>
                        <hr>
                        ...
                        <div style="color: black;" class="form-group">
                            <form action="{{ route('filter_advertisement') }}" method="GET">
                                ...
                                <div style="display: flex;gap:10px;" class="grouped-container">
                                    ...
                                    <a href="{{ route('master_vehicle_advertisement.index') }}"
                                ...
                                <tbody>
                                    ...
                                    @foreach ($vehicle_data as $vhcl)
                                        <tr style="width: 200px;">
                                            ...
                                            <td>
                                                @if ($vhcl->ads_id == null)
                                                    <a class="btn btn-primary"
                                                        href="{{ route('add_vehicle_advertisement', $vhcl->vehicle_id) }}">Pilih</a>
                                                @else
                                                    <div style="display:flex; justify-content:center;gap:8px; "
                                                        class="action">
                                                        <a style="size: 12px;" href="#" data-toggle="modal"
                                                            data-target="#deleteAds{{ $vhcl->vehicle_id }}"><i
                                            ...
                                            <td style="width:80px;">
                                                @if ($vhcl->foto_vehicle == null)
                                                    <p style="color: red;"><i
                                                            class="fa fa-info-circle"></i>&nbsp;Belum</p>
                                                @else
                                                    <p style="color:green;"><i
                                                            class="fa fa-check-circle"></i>&nbsp;Sudah</p>
                                                @endif
                                            </td>
                ...
                @foreach ($vehicle_data as $vads)
                    <div class="modal fade" id="deleteAds{{ $vads->vehicle_id }}" tabindex="-1" role="dialog"
                        aria-labelledby="exampleModalLabel{{ $vads->vehicle_id }}" aria-hidden="true">
                        <div class="modal-dialog" role="document">
                            <div class="modal-content">
                                <div class="modal-header">
                                    <h5 class="modal-title" id="exampleModalLabel{{ $vads->vehicle_id }}">Hapus data
                                        iklan: {{ $vads->unit }}</h5>
                ...
                <div class="modal fade" id="changeAds" tabindex="-1" role="dialog"
