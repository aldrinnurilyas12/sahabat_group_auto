                        ...
                        <form class="form_input" method="POST" action="{{ route('master_agenda.store')}}">
                            ...
                            <div class="form-group">
                                ...
                                <select class="form-control" name="branch" id="">
                                    ...
                                    <option value="{{$br->location_name}}">{{$br->location_name}}</option>        
                                    @endforeach
                                </select>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="agenda_name" autocomplete="off" placeholder="Masukan Nama Agenda">
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <input type="time" class="form-control" min="07:00" max="17:00" name="start_time" autocomplete="off">
                            </div>

                            <div class="form-group">
                                <label>Jam Akhir</label>
                                <input type="time" class="form-control" min="07:00" max="17:00" name="end_time" autocomplete="off">
                            </div>
