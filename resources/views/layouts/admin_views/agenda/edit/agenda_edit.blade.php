                        ...
                        <div class="form-group-content">
                            ...
                            <form class="form_input" method="POST" action="{{ route('agenda_update', $agendas->id) }}">
                                ...
                                <div class="form-group">
                                    ...
                                    <select class="form-control" name="department" id="">
                                        ...
                                        @foreach ($department as $dpt)
                                            <option value="{{ $dpt->id }}"
                                                {{ $dpt->department_name == $agendas->department_name ? 'selected' : '' }}>
                                                {{ $dpt->department_name }}</option>
                                        @endforeach
                                    </select>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <select class="form-control" name="branch" id="">
                                        ...
                                        @foreach ($branch as $br)
                                            <option value="{{ $br->id }}"
                                                {{ $br->location_name == $agendas->branch ? 'selected' : '' }}>
                                                {{ $br->location_name }}</option>
                                        @endforeach
                                    </select>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <select class="form-control" name="meeting_leader" id="">
                                        ...
                                        @foreach ($meeting_leader as $lead)
                                            <option value="{{ $lead->nik }}"
                                                {{ $lead->nik == $agendas->meeting_leader ? 'selected' : '' }}>
                                                [{{ $lead->nik }}] -
                                                {{ $lead->name }}</option>
                                        @endforeach
                                    </select>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" value="{{ $agendas->agenda_name }}"
                                        name="agenda_name" autocomplete="off">
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="date" class="form-control"
                                        ...
                                        name="agenda_date" autocomplete="off">
                                </div>
