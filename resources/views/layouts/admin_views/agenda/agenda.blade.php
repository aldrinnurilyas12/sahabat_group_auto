...
<head>
    ...
    <title>Data Agenda - SAHABAT GROUP AUTO ADMINISTRATOR</title>
                ...
                @include('layouts.admin_views.header')
                    ...
                    <div class="card shadow mb-4">
                        <div  class="card-header py-3">
                            <h5 style="color: black;"><strong>Data Agenda PT Sahabat Group Auto</strong></h5>
                            <br>
                            <div style="display: flex; flex-wrap:wrap; gap:10px;" class="component">
                            <a href="{{ route('agenda_create') }}" class="btn btn-primary">
                                    ...
                                    <tbody>
                                        ...
                                        <tr style="width: 200px;">
                                            ...
                                            <td><div style="display:flex; justify-content:center;gap:8px; " class="action">
                                                <a href="{{route('agenda_edit',['id'=> $agendas->id])}}"><i class="fas fa-edit"></i></a>
                                                <a style="size: 12px;" href="#" data-toggle="modal" data-target="#deleteUnit{{$agendas->id}}"><i class="fas fa-trash"></i></a>
                                            </td>
                                            <td>{{$agendas->department}}</td>
                                            <td>{{$agendas->branch}}</td>
                                            <td>{{$agendas->agenda_name}}</td>
                                            <td>{{\Carbon\Carbon::parse($agendas->agenda_date)->format('d F Y')}}</td>
