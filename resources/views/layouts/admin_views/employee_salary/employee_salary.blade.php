...
<body id="page-top">
                        ...
                        <div style="color: black;" class="form-group">
                            <form action="{{ route('filter_employee_salary') }}" method="GET">
                                ...
                                <div style="display: flex;gap:10px;" class="grouped-container">
                                    ...
                                    <a href="{{ route('master_employee_salary.index') }}"
                                        ...
                                        <tr style="width: 200px;">
                                            ...
                                            <td>
                                                <div style="display:flex; justify-content:center;gap:8px; "
                                                    class="action">
                                                    <a href="{{ route('edit_emp_salary', $emp_salary->id) }}"><i
                                                            class="fas fa-edit"></i></a>
                                                    <a style="size: 12px;" href="#" data-toggle="modal"
                                                        data-target="#deleteUnit{{ $emp_salary->id }}"><i
                                            ...
                                            <td>{{ $emp_salary->employee_total }} Karyawan &nbsp;
                                                <a style="text-decoration:underline;" href="#" data-toggle="modal"
                                                    data-target="#showData{{ $emp_salary->jb_id }}"> Lihat data <i
    ...
    @foreach ($employee_salary as $emp_salary)
        <div class="modal fade" id="deleteUnit{{ $emp_salary->id }}" tabindex="-1" role="dialog"
            aria-labelledby="exampleModalLabel{{ $emp_salary->id }}" aria-hidden="true">
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="exampleModalLabel{{ $emp_salary->id }}">Hapus data cabang:
                            {{ $emp_salary->position_name . ' - ' . $emp_salary->salary }}</h5>
    ...
    {{-- show data karyawan --}}
    @foreach ($employee_salary as $emp_salary)
        <div class="modal fade" id="showData{{ $emp_salary->jb_id }}" tabindex="-1" role="dialog"
            aria-labelledby="exampleModalLabel{{ $emp_salary->jb_id }}" aria-hidden="true">
            <div class="modal-dialog" role="document">
