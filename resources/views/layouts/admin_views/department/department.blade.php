...
<body id="page-top">
                                        ...
                                        <tr style="width: 200px;">
                                            ...
                                            <td>
                                                <div style="display:flex; justify-content:center;gap:8px; "
                                                    class="action">
                                                    <a href="{{ route('department_update', ['id' => $dept->id]) }}"><i
                                                            class="fas fa-edit"></i></a>
                                                    <a style="size: 12px;" href="#" data-toggle="modal"
                                                        data-target="#deleteUnit{{ $dept->id }}"><i
    ...
    @foreach ($department as $dept)
        <div class="modal fade" id="deleteUnit{{ $dept->id }}" tabindex="-1" role="dialog"
            aria-labelledby="exampleModalLabel{{ $dept->id }}" aria-hidden="true">
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="exampleModalLabel{{ $dept->id }}">Hapus data cabang:
                            {{ $dept->department_code . ' - ' . $dept->department_name }}</h5>
