...
<body>
    ...
    <div class="container">
        ...
        <p>Permohonan permintaan pencarian unit kendaraan {{ $data['brand_name'] . ' ' . $data['vehicle_type'] . ' ' . $data['year']  }}.</p>
        ...
        <p style="font-size:20px; font-style:italic;"><strong>{{$data['description']}}</strong></p>

        
        <p>Terima kasih atas permintaan pencarian unit kendaraan pada PT Sahabat Group Auto.</p>
