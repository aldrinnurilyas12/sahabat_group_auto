...
<body>
    ...
    <div class="spk-information">
        @foreach ($employee_leaves as $emp)
            ...
            <div class="container-name">
                <p>Tanggal Mulai Cuti</p>
                <p>{{ $emp->start_date }}</p>
            </div>

            <div class="container-name">
                <p>Tanggal Akhir Cuti</p>
                <p>{{ $emp->end_date }}</p>
            </div>

            <div class="container-name">
                <p>Total Durasi Cuti</p>
                <p>{{ $emp->duration_of_leaves }} Hari</p>
            </div>
    ...
    <br>
    <footer>
        <div style="margin-top: 4rem;" class="body-footer">
