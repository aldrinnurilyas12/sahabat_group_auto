    ...
    <section style="height: 500px; background-color:black; position: relative;">
        ...
        <div class="max-w-screen-xl px-4 pt-20 pb-8 mx-auto lg:gap-8 xl:gap-0 lg:py-16 lg:grid-cols-12 lg:pt-28"
            ...
            <div class="btn-contact" style="opacity: 1;">
                ...
                <a class="btn btn-dark" href="#appointment-create">Jual Mobil Anda <i class="fa fa-long-arrow-right"
                        aria-hidden="true"></i>
                </a>
            </div>
        </div>
        ...
        <!-- Image with opacity -->
        <img src="{{ asset('assets/images/deals.jpg') }}" alt=""
        ...
        <div class="max-w-screen-xl px-4 py-8 mx-auto space-y-12 lg:space-y-20 lg:py-24 lg:px-6">
            ...
            <div class="items-center gap-8 lg:grid lg:grid-cols-2 xl:gap-16">
                <div style="width:100%;" class="text-gray-500 sm:text-lg ">
                    <h3 style="color: black;" class="mb-4 text-3xl font-extrabold dark:text-white">Form Jual Unit
                        Kendaraan</h3>
                </div>
            </div>
            <!-- Row -->
                ...
                <div style="display: flex; gap:50px;flex-wrap:wrap;" class="form-group-content">
                    <form class="form_input" method="POST" action="{{ route('vehicle_request_save') }}">
                        ...
                        <div class="form-group">
                            ...
                            <input type="vehicle_type" class="form-control" name="vehicle_type"
                                placeholder="Masukan tipe unit kendaraan, cth: Veloz Sport" autocomplete="off">
                            @error('vehicle_type')
                                <div class="alert alert-danger">{{ $message }}</div>
                            @enderror
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" name="vehicle_year"
                                placeholder="Masukan tahun kendaraan" autocomplete="off">
                            @error('vehicle_year')
                                <div class="alert alert-danger">{{ $message }}</div>
                            @enderror
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <input type="email" class="form-control" name="email"
                                placeholder="Masukan email anda" autocomplete="off">
                            @error('email')
                                <div class="alert alert-danger">{{ $message }}</div>
                            @enderror
                        </div>
                        ...
                        <div style="display: flex;flex-wrap:wrap; gap:10px;" class="btn-component">
                            <button type="submit" class="btn btn-dark">Dapatkan Penawaran <i
                    ...
                    <div style="width: 400px; height:max-content;" class="card shadow mb-4">
                        ...
                        <div class="card-body">
                            <ul style="padding:0;">
                                ...
                                <br>
                                <li>Tim kami akan menghubungi anda setelah H-2 untuk melakukan konfirmasi permintaan
                                    penawaran Jual Unit Kendaraan</li>
                            </ul>
        ...
        <div class="max-w-screen-xl px-4 py-8 mx-auto text-center lg:py-24 lg:px-6">
            <div style="width:100%;height:max-content; border-radius:10px;border:1.5px solid gray;background:white;padding:15px;"
                ...
                <div class="max-w-screen-md mx-auto mb-3 text-center lg:mb-12">
                    <h2 class="mb-4 text-3xl font-extrabold tracking-tight text-gray-900 dark:text-white">Cek Status
                        Informasi Permintaan Penawaran Jual Unit Kendaraan</h2>
                    <p class="font-light text-gray-500 sm:text-xl dark:text-gray-400">Silahkan masukan token anda yang
                        sudah kami kirimkan melalui email.</p>
                </div>
                <form id="form-submit">
                    @csrf
                    ...
                    if (response.status === 'success' && response.data) {
                        ...
                        $.each(response.data, function(index, item) {
                            ...
                            $('#info-status .info-first').append(
                                ...
                                item.vehicle_color + ' ' + item.vehicle_year +
                                '</p>' +
                                '<p><strong>Pemilik/Pemohon:</strong><br>' +
                                item.name + '</p>' +
                                '<p><strong>Status:</strong><br>' + item
                                .status + '</p>' +
