...
<body>
        ...
        <div class="max-w-screen-xl px-4 pt-20 pb-8 mx-auto lg:gap-8 xl:gap-0 lg:py-16 lg:grid-cols-12 lg:pt-28"
            ...
            <div class="btn-contact" style="opacity: 1;">
                ...
                <p class="max-w-2xl mb-6" style="color: white;">
                    Ingin merasakan langsung produk pilihan Anda? Kami mengundang Anda untuk mengunjungi showroom kami!
                    Dapatkan pengalaman berbelanja yang lebih personal dengan melakukan appointment terlebih dahulu.
                </p>

                <a class="btn btn-dark" href="#appointment-create">Buat
                    Appointment <i class="fa fa-long-arrow-right" aria-hidden="true"></i>
                </a>
            </div>
        </div>

        <!-- Image with opacity -->
        <img src="{{ asset('assets/images/csss.jpg') }}" alt=""
            style="position: absolute; top: 0; left: 0; height: 100%; width: 100%; object-fit: cover; opacity: 0.6; z-index: 1;">
    </section>
        ...
        <div style="padding-bottom: 2rem;"
            ...
            <div class="items-center gap-8 lg:grid lg:grid-cols-2 xl:gap-16">
                <div class="text-gray-500 sm:text-lg ">
                    <h3 style="color: black;" class="mb-4 text-3xl font-extrabold dark:text-white">Kenapa harus membuat
                        janji?</h3>
                    ...
                    <ul style="color: black; padding-left:0;" role="list"
                        ...
                        <li class="flex space-x-3">
                            ...
                            <span class="text-base font-medium leading-tight text-gray-900 dark:text-white"> Pelayanan
                                Eksklusif: Anda akan dilayani secara langsung oleh tenaga ahli kami yang siap memberikan
                                informasi detail dan rekomendasi terbaik.</span>
                        </li>
                        <li class="flex space-x-3">
                            <!-- Icon -->
                            <svg class="flex-shrink-0 w-5 h-5 text-purple-500 dark:text-purple-400" fill="currentColor"
                            ...
                            <span class="text-base font-medium leading-tight text-gray-900 dark:text-white"> Kenyamanan
                                Maksimal: Hindari antrean dan nikmati waktu yang lebih fokus untuk memilih produk sesuai
                                keinginan.</span>
                        </li>
                        <li class="flex space-x-3">
                            <!-- Icon -->
                            ...
                            <span class="text-base font-medium leading-tight text-gray-900 dark:text-white">Kunjungan
                                Terjadwal: Kami akan mempersiapkan segala sesuatu sebelum kedatangan Anda, memastikan
                                Anda mendapatkan pengalaman yang menyenangkan.</span>
                        </li>

                    </ul>

                </div>
                <img class="hidden w-full mb-4 rounded-lg lg:mb-0 lg:flex" src="{{ asset('assets/images/cs.jpg') }}"
    ...
    <section id="filterBranch" style="background-image: linear-gradient(to bottom, #003fd2 10%, #4498fff7 80%);">
        <div style="padding-top:30px;padding-bottom:3rem;"
            class="max-w-screen-xl px-4 py-8 mx-auto space-y-12 lg:space-y-20 lg:py-24 lg:px-6">
            <!-- Row -->
            <div style="display: block;color:white;">
                ...
                <div style="display: flex; gap:20px;justify-content:space-between;font-size:14px;"
                    class="filter-location">
                    <h5>Tanggal : <?php echo date('d F Y'); ?></h5>

                    <div class="filter-content">
                        <form method="GET" action="{{ route('filter_branch') }}">
                            <select style="height: max-content;text-align:center;border-radius:5px;color:black;"
                                name="location_unit" id="">
            ...
            <div style="background-color:rgb(255, 255, 255); width:100%; height:300px; padding:0; overflow-x:scroll;"
                class="schedule-time">
                <table style="width: 100%; overflow-x:auto;" border="1">
                    ...
                    <tbody>
                                        ...
                                        @foreach ($vehicle_new as $ads)
                                            <td>
                                                @php
                                                    ...
                                                    $matchedAd = $vehicle_ads->firstWhere(function ($vehicle_ad) use (
                                                        $ads,
                                                        $time,
                                                    ) {
                                                        return $vehicle_ad->ads_id == $ads->ads_id &&
                                                            $vehicle_ad->schedule_time == $time->schedule_time;
                                                    });
                                                @endphp

                                                @if ($matchedAd)
                                                    <!-- Jika ada kendaraan yang sudah terdaftar pada waktu tersebut -->
                                                    <span
                                                        style="background:rgba(255, 54, 138, 0.445); color:rgb(128, 0, 0); padding:5px; border-radius:5px;">Booked</span>
                                                @else
                                                    <!-- Jika tidak ada kendaraan yang terdaftar pada waktu tersebut -->
                                                    <span
                                                        style="background:rgba(54, 255, 54, 0.445); color:green; padding:5px; border-radius:5px;">Available</span>
                                                @endif
                                            </td>
                                        @endforeach
                                    @endif
                        ...
                        @else
                            <tr>
                                <td colspan="{{ count($vehicle_new) + 1 }}" style="text-align: center;">Tidak ada
                                    data jadwal</td>
                            </tr>
                        @endif
        ...
        <div class="max-w-screen-xl px-4 py-8 mx-auto space-y-12 lg:space-y-20 lg:py-24 lg:px-6">
            ...
            <div class="items-center gap-8 lg:grid lg:grid-cols-2 xl:gap-16">
                <div style="width:100%;" class="text-gray-500 sm:text-lg ">
                    <h3 style="color: black;" class="mb-4 text-3xl font-extrabold dark:text-white">Pilih Jadwal
                        Kunjungan Anda</h3>
                </div>
            </div>
            <!-- Row -->
            ...
            <div style="margin: 0; padding:0;" id="content">
                ...
                <div style="display: flex; gap:50px;flex-wrap:wrap;" class="form-group-content">
                    <form class="form_input" method="POST" action="{{ route('appointment_save') }}">
                        ...
                        <div class="form-group">
                            <input hidden id="showLocation" type="text" name="branch_id"
                                value="{{ old('branch_id') }}" readonly>
                        </div>
                        ...
                        <br>
                        <button type="submit" class="btn btn-dark">Kirim Appointment <i
    ...
    <style>
        ...
        .fixed-column {
            ...
            z-index: 1;
            /* Pastikan kolom waktu berada di atas konten lainnya */
            box-shadow: 1px 0 5px rgba(0, 0, 0, 0.1);
            /* Memberikan sedikit bayangan agar kolom terlihat lebih jelas */
        }
