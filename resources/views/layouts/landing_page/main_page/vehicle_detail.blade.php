...
<body>
                    ...
                    @foreach ($vehicle_data as $vehicle)
                        <div class="wrapper row">
                            <div style="height: max-content;" class="preview col-md-6">
                                        ...
                                        <div style="margin-bottom: 20px;" class="carousel-inner">
                                            @foreach ($vehicle_fotos as $key => $img)
                                                <div class="carousel-item {{ $key === 0 ? 'active' : '' }}">
                                                    <img style="height:400px; object-fit:cover;" class="d-block w-100"
                                ...
                                <div class="scroll-images" style="width: 39rem; overflow-x: auto;">
                                    <ul style="width: max-content;" class="preview-thumbnail nav nav-tabs">
                                        @foreach ($vehicle_fotos as $key => $vehicles)
                                            <li class="nav-item">
                                                <a class="nav-link {{ $key === 0 ? 'active' : '' }}" href="#"
                                ...
                                @php
                                    $url = url($vehicle_data->first()->unit);
                                ...
                                <div style="display: flex; gap:10px;align-items:center;margin-top:10px;"
                                    ...
                                    <div style="display: flex; flex-wrap:wrap; gap:10px;" class="media-playback">
                                        <div class="video-player">
                                            <a href="#" data-toggle="modal"
                                                data-target="#videoPlayer{{ $vehicle->ads_id }}"
                                                style="background:whitesmoke;color:black;border:none;"
                                                class="btn btn-dark"><i class="fa fa-play-circle"
                                                    aria-hidden="true"></i>
                                                Putar Video
                                            </a>
                                        </div>
                                        ...
                                        <div class="engine-sound">
                                            <a href="#" data-toggle="modal"
                                                data-target="#soundPlayer{{ $vehicle->ads_id }}"
                                                style="background:whitesmoke;color:black;border:none;"
                                                class="btn btn-dark"><i class="fa fa-car" aria-hidden="true"></i>
                                                Suara Mesin
                                            </a>
                                        </div>
                                    </div>
                                    ...
                                    <div class="sharing-links">
                                        <a style="padding: 7px;background:whitesmoke;color:black;border-radius:4px; text-decoration:none;"
                                            href="{{ $whatsapplink }}" target="_blank"> <i class="fab fa-whatsapp"></i>
                                            Bagikan</a>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div style="padding-top:10px; margin-bottom:10px;" class="details col-md-6">
                                ...
                                <h5>{{ $vehicle->unit }}</h5>
                                <p style="background:#fffff4; padding:4px; border-radius:4px;width:max-content;height:max-content;font-size:12px;"
                                    class="location-unit">
                                ...
                                <div style="display: flex; gap:20px; flex-wrap:wrap;margin-bottom:0;"
                                    ...
                                    <div class="credit-price">
                                        <label style="font-weight: normal;font-size: 12px; color:gray;"
                                            for="">Harga Kredit</label>
                                        <h4 style="font-weight: bold;">
                                            {{ 'Rp ' . number_format($vehicle->credit_price) }}</h4>
                                    </div>
                                </div>

                                <div style="margin-bottom: 20px;" class="views">
                                    @if ($vehicle->clicked)
                                        <i style="color: gray;" class="fa fa-eye" aria-hidden="true"> <span
                                                style="color: black;">{{ $vehicle->clicked }}x dilihat</span></i>
                                    @else
                                        <i style="color: gray;" class="fa fa-eye" aria-hidden="true"> <span
                                                style="color: black;">belum dilihat</span></i>
                                    @endif
                                </div>


                                <div style="width: 100%; height:max-content:20px;border-radius:10px;padding-left:0;"
                                    class="container">
                                    <div class="title">
                                        <h6><strong>Informasi Detail Unit Kendaraan</strong></h6>
                                    </div>
                                    <div style="width: 100%; height:max-content;background:#ffffff;padding:20px;border:1.5px solid rgb(241, 241, 241);border-radius:10px;display:flex;flex-wrap:wrap;gap:40px;"
                                        ...
                                        <div style="display: block; gap:5px;align-items:center;"
                                            ...
                                            <p style="margin-bottom: 0;font-weight:bold;">
                                                {{ $vehicle->manufacture_year }}</p>
                                        </div>

                                        <div style="display: block; gap:5px;align-items:center;"
                                            class="detail-sub-info">
                                            <p style="font-size: 12px; color:gray;margin-bottom:0;">Bahan Bakar</p>
                                            <p style="margin-bottom: 0;font-weight:bold;">{{ $vehicle->fuel_type }}
                                            </p>
                                        </div>
                                        ...
                                        <div style="display: block; gap:5px;align-items:center;"
                                            ...
                                            <p style="margin-bottom: 0;font-weight:bold;">
                                                {{ number_format($vehicle->cylinder_capacity) . ' cc' }}</p>
                                        </div>
                                        ...
                                        <div style="display: block; gap:5px;align-items:center;"
                                            ...
                                            <p style="margin-bottom: 0;font-weight:bold;">
                                                {{ number_format($vehicle->current_km) . ' km' }}</p>
                                        </div>
    ...
    <section style="padding: 10px;" class="more-information">
        <div class="card-body">
            ...
            {{-- tab --}}
            <!-- Tabs navs -->
            <ul style="display: flex;justify-content:center;gap:20px;" class="nav nav-tabs mb-3" id="ex1"
                role="tablist">
                <li class="nav-item" role="presentation">
                    <a data-mdb-tab-init class="nav-link active" id="ex1-tab-1" href="#ex1-tabs-1" role="tab"
                        aria-controls="ex1-tabs-1" aria-selected="true">Deskripsi Kendaraan</a>
                </li>
                <li class="nav-item" role="presentation">
                    <a data-mdb-tab-init class="nav-link" id="ex1-tab-2" href="#ex1-tabs-2" role="tab"
                        aria-controls="ex1-tabs-2" aria-selected="false">Rincian Kredit</a>
                </li>
            </ul>
            ...
            <div class="tab-content" id="ex1-content">
                ...
                <div style="padding: 40px;" class="tab-pane fade show active" id="ex1-tabs-1" role="tabpanel"
                ...
                <div class="tab-pane fade" id="ex1-tabs-2" role="tabpanel" aria-labelledby="ex1-tab-2">
                    ...
                    @else
                        <span style="display: flex; justify-content:center;">Tidak ada data kredit untuk unit
                            {{ $vehicle_data->first()->unit }}</span>
                    @endif
                </div>
            </div>
        </div>
    ...
    {{-- modal video player --}}
    @foreach ($vehicle_data as $vehicle)
        <div class="modal fade" id="videoPlayer{{ $vehicle->ads_id }}" tabindex="-1" role="dialog"
            aria-labelledby="exampleModalLabel{{ $vehicle->ads_id }}" aria-hidden="true">
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    <div style="display: flex; justify-content:space-between;" class="modal-header">
                        <h5 class="modal-title" id="exampleModalLabel{{ $vehicle->ads_id }}">Video :
                            {{ $vehicle->unit }}</h5>
    ...
    {{-- modal sound player --}}
    @foreach ($vehicle_data as $vehicle)
        <div class="modal fade" id="soundPlayer{{ $vehicle->ads_id }}" tabindex="-1" role="dialog"
            aria-labelledby="exampleModalLabel{{ $vehicle->ads_id }}" aria-hidden="true">
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    <div style="display: flex; justify-content:space-between;" class="modal-header">
                        <h5 class="modal-title" id="exampleModalLabel{{ $vehicle->ads_id }}">Suara Mesin :
                            {{ $vehicle->unit }}</h5>
                        <button class="close" type="button" data-dismiss="modal" aria-label="Close">
                            <span aria-hidden="true">×</span>
                        </button>
